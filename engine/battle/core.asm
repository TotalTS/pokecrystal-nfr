...
; Used by Red Gyarados at Lake of Rage
	cp BATTLETYPE_SUICUNE
	jr nz, .Gyarados ;if not Suicune, it's Gyarados

	call Random
	cp 50 percent + 1 ;50% of being a Shiny Suicune Battle
	jr c, .GenerateDVs ;it's normal Suicune
	ld b, ATKDEFDV_SHINY ; $ea
	ld c, SPDSPCDV_SHINY ; $aa
	jr .UpdateDVs ;is Shiny Suiucune
.Gyarados
	cp BATTLETYPE_SHINY
	jr nz, .GenerateDVs
